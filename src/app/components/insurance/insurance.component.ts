  ...
  buyInsurance(vrstaPlacanja) {
    ...
    this.insuranceDataService.buyInsurance(polisa).subscribe(
      (data) => {
        ...
        if(vrstaPlacanja==VrstaPlacanja.PayPal) {
          window.location.href = "http://localhost:4200/insurance-payment-failed"+this.buyPolicyDTO.orderId;
        }
